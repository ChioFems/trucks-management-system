...
class CustomServerpodAuthScreen extends StatefulWidget {
  final Caller caller;
  final VoidCallback onSignedIn;
  final int maxPasswordLength;
  final int minPasswordLength;

  const CustomServerpodAuthScreen({
    Key? key,
  ...
  @override
  CustomServerpodAuthScreenState createState() =>
      CustomServerpodAuthScreenState();
}

class CustomServerpodAuthScreenState extends State<CustomServerpodAuthScreen> {
...
void showCustomServerpodSignIn({
  ...
  showDialog(
    context: context,
    builder: (context) {
      return CustomServerpodAuthScreen(
        caller: caller,
